...
public class Call_Screen_Blurry_Dark extends AppCompatActivity implements View.OnClickListener, SensorEventListener {
    Holder holder;
    ShapeDrawable mDrawable;
    private final BroadcastReceiver stop_fake_call = new BroadcastReceiver() { // from class: com.softdroid.fake.call.Call_Screens.Call_Screen_Blurry_Dark.1
        @Override // android.content.BroadcastReceiver
        public void onReceive(Context context, Intent intent) {
            Call_Screen_Blurry_Dark.this.stopPlaying();
            try {
                Call_Screen_Blurry_Dark.this.holder.r.stop();
            } catch ( Exception unused) {
            }
            try {
                if (Call_Screen_Blurry_Dark.this.holder.sharedPreferences.getBoolean(Call_Screen_Blurry_Dark.this.getResources().getString(R.string.vibration_pref), true)) {
                    Call_Screen_Blurry_Dark.this.holder.vibrator.cancel();
                }
            } catch ( Exception unused2) {
            }
            try {
                Call_Screen_Blurry_Dark.this.holder.cutom_ringtone_player.stop();
            } catch ( Exception unused3) {
            }
            Call_Screen_Blurry_Dark.this.finish();
        }
    };
    ...
    public class Holder {
        ...
        int[] color_bg = {R.color.transparent_circle10, R.color.transparent_circle9, R.color.transparent_circle8, R.color.transparent_circle7, R.color.transparent_circle6, R.color.transparent_circle5, R.color.transparent_circle4, R.color.transparent_circle3, R.color.transparent_circle2, R.color.transparent_circle1};
        ...
        public Holder() {
            //Call_Screen_Blurry_Dark.this = r4;
        }
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_call__screen__blurry__dark);
    ...
    private void getting_prefrence() {
        ...
        if (!this.holder.sharedPreferences.getBoolean("gallery_image", false)) {
            if (!this.holder.sharedPreferences.getBoolean("custom_image", false)) {
                switch (this.holder.sharedPreferences.getInt("position", 2)) {
                    case 1:
                        ...
                        this.holder.image_of_caller_top_c.setImageResource(R.mipmap.pizza);
                        this.holder.image_of_caller_top.setImageResource(R.mipmap.pizza_big);
                        this.holder.path_image = "pizza";
                        break;
                    case 2:
                        this.holder.image_of_caller_top_c.setImageResource(R.mipmap.girlfriend);
                    ...
                    case 3:
                        ...
                        this.holder.image_of_caller_top_c.setImageResource(R.mipmap.mom);
                        this.holder.image_of_caller_top.setImageResource(R.mipmap.mom_big);
                        this.holder.path_image = "mom";
                        break;
                    case 4:
                        this.holder.image_of_caller_top_c.setImageResource(R.mipmap.boyfriend);
                        ...
                        break;
                    case 5:
                        this.holder.image_of_caller_top_c.setImageResource(R.mipmap.dad);
                        ...
                        break;
                    case 6:
                        this.holder.image_of_caller_top_c.setImageResource(R.mipmap.husband);
                        ...
                        break;
                    case 7:
                        this.holder.image_of_caller_top_c.setImageResource(R.mipmap.wife);
                        ...
                        break;
                    case 8:
                        this.holder.image_of_caller_top_c.setImageResource(R.mipmap.boss);
                        ...
                        break;
                    case 9:
                        this.holder.image_of_caller_top_c.setImageResource(R.mipmap.doctor);
                        ...
                        break;
                    case 10:
                        this.holder.image_of_caller_top_c.setImageResource(R.mipmap.lawyer);
                        ...
                        break;
                    case 11:
                        this.holder.image_of_caller_top_c.setImageResource(R.mipmap.president);
                        ...
                        break;
                    case 12:
                        this.holder.image_of_caller_top_c.setImageResource(R.mipmap.ronaldo);
                        ...
                        break;
                    case 13:
                        this.holder.image_of_caller_top_c.setImageResource(R.mipmap.santa);
                        this.holder.image_of_caller.setImageResource(R.mipmap.santa);
                        this.holder.image_of_caller_top.setImageResource(R.mipmap.santa);
                ...
                Glide.with((FragmentActivity) this).load(this.holder.sharedPreferences.getString("custom_image_path", "")).into(this.holder.image_of_caller_top_c);
            ...
            Glide.with((FragmentActivity) this).load(this.holder.sharedPreferences.getString("imagepath", "")).into(this.holder.image_of_caller_top_c);
    ...
    private void initilize_componenets() {
        ...
        this.holder.caller_image_layout = (RelativeLayout) findViewById(R.id.caller_image_layout);
        ...
        this.holder.image_of_caller = (CircleImageView) findViewById(R.id.image_of_caller_top_c);
        this.holder.image_of_caller_top_c = (CircleImageView) findViewById(R.id.image_of_caller);
        ...
        this.holder.ripple = (LottieAnimationView) findViewById(R.id.progressBar);
        this.holder.ripple.setVisibility(View.VISIBLE);
        this.holder.pick_call.setOnClickListener(new View.OnClickListener() { // from class: com.softdroid.fake.call.Call_Screens.Call_Screen_Blurry_Dark.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                Call_Screen_Blurry_Dark.this.holder.handler.removeCallbacksAndMessages(null);
                Call_Screen_Blurry_Dark.this.holder.pick_call.setVisibility(View.GONE);
                Call_Screen_Blurry_Dark.this.holder.cancel_call.setVisibility(View.GONE);
                Call_Screen_Blurry_Dark.this.holder.cancel_call_new.setVisibility(View.VISIBLE);
                Call_Screen_Blurry_Dark.this.holder.action_layout.setVisibility(View.VISIBLE);
                Call_Screen_Blurry_Dark.this.holder.caller_image_layout.setVisibility(View.GONE);
                Call_Screen_Blurry_Dark.this.holder.image_of_caller.setVisibility(View.VISIBLE);
                Call_Screen_Blurry_Dark.this.holder.pick_call_layout.setVisibility(View.GONE);
                Call_Screen_Blurry_Dark.this.holder.reject_call_layout.setVisibility(View.GONE);
                if (Call_Screen_Blurry_Dark.this.holder.sharedPreferences.getBoolean(Call_Screen_Blurry_Dark.this.getResources().getString(R.string.vibration_pref), true)) {
                    Call_Screen_Blurry_Dark.this.holder.vibrator.cancel();
                }
                try {
                ...
                Call_Screen_Blurry_Dark.this.holder.chronometer.setBase(SystemClock.elapsedRealtime());
                Call_Screen_Blurry_Dark.this.holder.chronometer.setVisibility(View.VISIBLE);
                Call_Screen_Blurry_Dark.this.holder.timer_textview.setVisibility(View.GONE);
                Call_Screen_Blurry_Dark.this.holder.chronometer.stop();
                Call_Screen_Blurry_Dark.this.holder.chronometer.start();
                try {
                    Call_Screen_Blurry_Dark.this.holder.r.stop();
                } catch (NullPointerException unused2) {
                }
                try {
                    if (new File(Call_Screen_Blurry_Dark.this.holder.mFileName).exists()) {
                        Call_Screen_Blurry_Dark.this.startPlaying();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
                Call_Screen_Blurry_Dark.this.holder.fake_call_picked = true;
            }
        });
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.cancel_call /* 2131230854 */:
                ...
                this.holder.caller_image_layout.setVisibility(View.VISIBLE);
                this.holder.handler.removeCallbacksAndMessages(null);
            ...
            case R.id.pick_call /* 2131231064 */:
                this.holder.handler.removeCallbacksAndMessages(null);
                this.holder.caller_image_layout.setVisibility(View.GONE);
    ...
    private void change_main_color(boolean z) {
        if (z) {
            new Thread(new Runnable() { // from class: com.softdroid.fake.call.Call_Screens.Call_Screen_Blurry_Dark.3
                ...
                public void run() {
                    while (true) {
                        ...
                        Call_Screen_Blurry_Dark.this.updateColor();
                        Call_Screen_Blurry_Dark.this.holder.whichColor = !Call_Screen_Blurry_Dark.this.holder.whichColor;
                    }
                }
            }).start();
            return;
    ...
    public void updateColor() {
        runOnUiThread(new Runnable() { // from class: com.softdroid.fake.call.Call_Screens.Call_Screen_Blurry_Dark.4
            @Override // java.lang.Runnable
            public void run() {
                if (Call_Screen_Blurry_Dark.this.holder.whichColor) {
                    Call_Screen_Blurry_Dark.this.mDrawable.getPaint().setShader(new LinearGradient(0.0f, 0.0f, 0.0f, (float) Call_Screen_Blurry_Dark.this.holder.main_layout.getHeight(), Call_Screen_Blurry_Dark.this.getResources().getColor(R.color.s7_green), Call_Screen_Blurry_Dark.this.getResources().getColor(R.color.s7_perpul), Shader.TileMode.REPEAT));
                    Call_Screen_Blurry_Dark.this.holder.main_layout.setBackgroundDrawable(Call_Screen_Blurry_Dark.this.mDrawable);
                    return;
                }
                Call_Screen_Blurry_Dark.this.mDrawable.getPaint().setShader(new LinearGradient(0.0f, 0.0f, 0.0f, (float) Call_Screen_Blurry_Dark.this.holder.main_layout.getHeight(), Call_Screen_Blurry_Dark.this.getResources().getColor(R.color.s7_green), Call_Screen_Blurry_Dark.this.getResources().getColor(R.color.s7_perpul), Shader.TileMode.REPEAT));
                Call_Screen_Blurry_Dark.this.holder.main_layout.setBackgroundDrawable(Call_Screen_Blurry_Dark.this.mDrawable);
    ...
    private void finish_Timer() {
        new Handler().postDelayed(new Runnable() { // from class: com.softdroid.fake.call.Call_Screens.Call_Screen_Blurry_Dark.5
            @Override // java.lang.Runnable
            public void run() {
                try {
                    Call_Screen_Blurry_Dark.this.holder.mSensorManager.unregisterListener(Call_Screen_Blurry_Dark.this);
                } catch ( Exception unused) {
                }
                Call_Screen_Blurry_Dark.this.holder.sharedPreferences.edit().putBoolean("fake_call_actvie", false).apply();
                Call_Screen_Blurry_Dark.this.finish();
            }
        }, 1600);
    }
    ...
    private void finish_call_when_not_picked_up() {
        new Handler().postDelayed(new Runnable() { // from class: com.softdroid.fake.call.Call_Screens.Call_Screen_Blurry_Dark.6
            @Override // java.lang.Runnable
            public void run() {
                if (!Call_Screen_Blurry_Dark.this.holder.fake_call_picked.booleanValue()) {
                    Call_Screen_Blurry_Dark.this.holder.sharedPreferences.edit().putBoolean("fake_call_actvie", false).apply();
                    if (Call_Screen_Blurry_Dark.this.holder.sharedPreferences.getBoolean(Call_Screen_Blurry_Dark.this.getResources().getString(R.string.vibration_pref), true)) {
                        Call_Screen_Blurry_Dark.this.holder.vibrator.cancel();
                    }
